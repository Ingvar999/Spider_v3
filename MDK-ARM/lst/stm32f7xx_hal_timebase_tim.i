#line 1 "../Src/stm32f7xx_hal_timebase_TIM.c"
...
#line 51 "../Src/stm32f7xx_hal_timebase_TIM.c"
#line 52 "../Src/stm32f7xx_hal_timebase_TIM.c"
...
HAL_StatusTypeDef HAL_InitTick(uint32_t TickPriority)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (0U)))); ((void)(tmpreg)); } while(0);
  ...
  htim2.Init.CounterMode = ((uint32_t)0x0000U);
