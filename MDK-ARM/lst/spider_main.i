#line 1 "..\\Src\\spider\\spider_main.c"
...
#line 10 "..\\Src\\spider\\spider_main.c"
...
#line 11 "..\\Src\\spider\\spider_main.c"
...
#line 12 "..\\Src\\spider\\spider_main.c"
...
#line 13 "..\\Src\\spider\\spider_main.c"
#line 1 "../Inc/spider/debug_utils.h"
...
#line 10 "../Inc/spider/debug_utils.h"
...
#line 11 "../Inc/spider/debug_utils.h"
#line 12 "../Inc/spider/debug_utils.h"
...
#line 14 "..\\Src\\spider\\spider_main.c"
...
#line 15 "..\\Src\\spider\\spider_main.c"
#line 1 "../Inc/spider/drv/drv_servo.h"
...
void cli_event_handler(const char *data, uint32_t len)
{
	if (!cli_in_process){
		...
		if (osThreadResume(defaultTaskHandle) != osOK){
			{ while (_tx_uart_busy) __asm("nop"); _tx_uart_busy = 1; HAL_UART_Transmit_IT((&huart3), txBuf, sprintf((char *)txBuf, "Resume thread failed\n"));};
		}
	}
}
...
void post_init_handler(void)
{
	const osThreadDef_t os_thread_def_defaultTask = { "defaultTask", (StartDefaultTask), (osPriorityNormal), (0), (((uint16_t)128))};
  defaultTaskHandle = osThreadCreate(&os_thread_def_defaultTask, 0);
	const osThreadDef_t os_thread_def_defaultTask1 = { "defaultTask1", (StartDefaultTask1), (osPriorityNormal), (0), (((uint16_t)128))};
  defaultTaskHandle1 = osThreadCreate(&os_thread_def_defaultTask1, 0);
	start_cli_handling('\n', cli_event_handler);
	drv_servo_init();
	{ while (_tx_uart_busy) __asm("nop"); _tx_uart_busy = 1; HAL_UART_Transmit_IT((&huart3), txBuf, sprintf((char *)txBuf, "Init Done!\n"));};
}
...
static void StartDefaultTask(void const * argument)
{
	while (1)
	{
		...
		if (osThreadSuspend(osThreadGetId()) != osOK){
			{ while (_tx_uart_busy) __asm("nop"); _tx_uart_busy = 1; HAL_UART_Transmit_IT((&huart3), txBuf, sprintf((char *)txBuf, "Suspend thread failed\n"));};
		}
	}
}
...
static void StartDefaultTask1(void const * argument)
{
	while (1)
	{
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((uint16_t)0x0080U), GPIO_PIN_SET);
		osDelay(2 * (1000));
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((uint16_t)0x0080U), GPIO_PIN_RESET);
