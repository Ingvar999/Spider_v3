...
#line 115 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dma.c"
...
HAL_StatusTypeDef HAL_DMA_Init(DMA_HandleTypeDef *hdma)
{
  ...
  if(hdma->Init.FIFOMode == ((uint32_t)(0x1U << (2U))))
  {
    ...
    if (hdma->Init.MemBurst != ((uint32_t)0x00000000U))
    {
...
HAL_StatusTypeDef HAL_DMA_PollForTransfer(DMA_HandleTypeDef *hdma, HAL_DMA_LevelCompleteTypeDef CompleteLevel, uint32_t Timeout)
{
  ...
  if(CompleteLevel == HAL_DMA_FULL_TRANSFER)
  {
    ...
    mask_cpltlevel = ((uint32_t)0x00000020U) << hdma->StreamIndex;
  }
  else
  {
     
    mask_cpltlevel = ((uint32_t)0x00000010U) << hdma->StreamIndex;
  }
  
  regs = (DMA_Base_Registers *)hdma->StreamBaseAddress;
  tmpisr = regs->ISR;
  
  while(((tmpisr & mask_cpltlevel) == RESET) && ((hdma->ErrorCode & ((uint32_t)0x00000001U)) == RESET))
  {
...
void HAL_DMA_IRQHandler(DMA_HandleTypeDef *hdma)
{
  ...
  if ((tmpisr & (((uint32_t)0x00000008U) << hdma->StreamIndex)) != RESET)
  {
    if((((((uint32_t)(0x1U << (2U)))) != ((uint32_t)0x00000080U))? ((hdma)->Instance ->CR & (((uint32_t)(0x1U << (2U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1U << (2U)))))) != RESET)
    {
  ...
  if ((tmpisr & (((uint32_t)0x00800004U) << hdma->StreamIndex)) != RESET)
  {
    if((((((uint32_t)(0x1U << (1U)))) != ((uint32_t)0x00000080U))? ((hdma)->Instance ->CR & (((uint32_t)(0x1U << (1U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1U << (1U)))))) != RESET)
    {
  ...
  {
    if((((((uint32_t)(0x1U << (3U)))) != ((uint32_t)0x00000080U))? ((hdma)->Instance ->CR & (((uint32_t)(0x1U << (3U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1U << (3U)))))) != RESET)
    {
  ...
  {
    if((((((uint32_t)(0x1U << (4U)))) != ((uint32_t)0x00000080U))? ((hdma)->Instance ->CR & (((uint32_t)(0x1U << (4U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1U << (4U)))))) != RESET)
    {
