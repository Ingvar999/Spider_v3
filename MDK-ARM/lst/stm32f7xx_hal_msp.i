...
#line 51 "../Src/stm32f7xx_hal_msp.c"
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  if(hi2c->Instance==((I2C_TypeDef *) (0x40000000U + 0x5400U)))
  {
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0100U)|((uint16_t)0x0200U);
    GPIO_InitStruct.Mode = ((uint32_t)0x00000012U);
    GPIO_InitStruct.Pull = ((uint32_t)0x00000001U);
    GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
    GPIO_InitStruct.Alternate = ((uint8_t)0x04U);
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), &GPIO_InitStruct);

     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (21U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (21U)))); ((void)(tmpreg)); } while(0);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  if(hi2c->Instance==((I2C_TypeDef *) (0x40000000U + 0x5400U)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((uint16_t)0x0100U)|((uint16_t)0x0200U));
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  GPIO_InitTypeDef GPIO_InitStruct;
  if(huart->Instance==((USART_TypeDef *) (0x40000000U + 0x4800U)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (18U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (18U)))); ((void)(tmpreg)); } while(0);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  if(huart->Instance==((USART_TypeDef *) (0x40000000U + 0x4800U)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0100U)|((uint16_t)0x0200U));
