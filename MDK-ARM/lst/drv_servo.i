#line 1 "..\\Src\\spider\\drv\\drv_servo.c"
...
#line 10 "..\\Src\\spider\\drv\\drv_servo.c"
...
#line 11 "..\\Src\\spider\\drv\\drv_servo.c"
...
#line 12 "..\\Src\\spider\\drv\\drv_servo.c"
...
#line 13 "..\\Src\\spider\\drv\\drv_servo.c"

extern I2C_HandleTypeDef hi2c1;

#line 24 "..\\Src\\spider\\drv\\drv_servo.c"
...
void drv_servo_set(uint8_t port, uint16_t value)
{
	if (value <= 180)
	{
		uint8_t pca_addr = (0x80) + (port / (16));
		port = port % (16);
		value = angle_to_pulse(value);
		{ while (_tx_uart_busy) __asm("nop"); _tx_uart_busy = 1; HAL_UART_Transmit_IT((&huart3), txBuf, sprintf((char *)txBuf, "%d\n", value));};
		pca9685_pwm((&hi2c1), pca_addr, port, 0, value);
	}
}
