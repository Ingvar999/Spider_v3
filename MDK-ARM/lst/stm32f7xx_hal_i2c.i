...
#line 243 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2c.c"
...
#line 271 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2c.c"
...
#line 285 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_i2c.c"
...
HAL_StatusTypeDef HAL_I2C_Master_Transmit(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    {
      hi2c->XferSize = 255U;
      I2C_TransferConfig(hi2c, DevAddress, hi2c->XferSize, (0x1U << (24U)), (0x1U << (13U)));
    }
    else
    {
      hi2c->XferSize = hi2c->XferCount;
      I2C_TransferConfig(hi2c, DevAddress, hi2c->XferSize, (0x1U << (25U)), (0x1U << (13U)));
    }
...
HAL_StatusTypeDef HAL_I2C_Master_Receive(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    {
      hi2c->XferSize = 255U;
      I2C_TransferConfig(hi2c, DevAddress, hi2c->XferSize, (0x1U << (24U)), (uint32_t)((0x1U << (13U)) | (0x1U << (10U))));
    }
    else
    {
      hi2c->XferSize = hi2c->XferCount;
      I2C_TransferConfig(hi2c, DevAddress, hi2c->XferSize, (0x1U << (25U)), (uint32_t)((0x1U << (13U)) | (0x1U << (10U))));
    }
...
HAL_StatusTypeDef HAL_I2C_Master_Transmit_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    I2C_TransferConfig(hi2c, DevAddress, hi2c->XferSize, xfermode, (0x1U << (13U)));
...
HAL_StatusTypeDef HAL_I2C_Master_Receive_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size)
{
  ...
  if(hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    I2C_TransferConfig(hi2c, DevAddress, hi2c->XferSize, xfermode, (uint32_t)((0x1U << (13U)) | (0x1U << (10U))));
...
{
  uint32_t xfermode = 0U;
  uint32_t xferrequest = (uint32_t)((0x1U << (13U)) | (0x1U << (10U)));
...
HAL_StatusTypeDef HAL_I2C_Master_Abort_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress)
{
  if(hi2c->Mode == HAL_I2C_MODE_MASTER)
  {
    ...
    I2C_TransferConfig(hi2c, DevAddress, 1, (0x1U << (25U)), (0x1U << (14U)));
...
static HAL_StatusTypeDef I2C_Slave_ISR_DMA(struct __I2C_HandleTypeDef *hi2c, uint32_t ITFlags, uint32_t ITSources) 
{
  ...
  if(((ITFlags & (0x1U << (4U))) != RESET) && ((ITSources & (0x1U << (4U))) != RESET))
  {
    ...
    if(((((hi2c)->State) == HAL_I2C_STATE_BUSY_TX) ? ((uint32_t)((hi2c)->hdmatx->Instance ->NDTR)) : ((uint32_t)((hi2c)->hdmarx->Instance ->NDTR))) == 0U)
    {
...
static HAL_StatusTypeDef I2C_RequestMemoryWrite(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint32_t Timeout, uint32_t Tickstart)
{
  I2C_TransferConfig(hi2c,DevAddress,MemAddSize, (0x1U << (24U)), (0x1U << (13U)));
...
static HAL_StatusTypeDef I2C_RequestMemoryRead(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint32_t Timeout, uint32_t Tickstart)
{
  I2C_TransferConfig(hi2c,DevAddress,MemAddSize, (0x00000000U), (0x1U << (13U)));
...
static void I2C_ITSlaveCplt(I2C_HandleTypeDef *hi2c, uint32_t ITFlags)
{
  ...
  {
    hi2c->XferCount = ((((hi2c)->State) == HAL_I2C_STATE_BUSY_TX) ? ((uint32_t)((hi2c)->hdmatx->Instance ->NDTR)) : ((uint32_t)((hi2c)->hdmarx->Instance ->NDTR)));
  }
...
static void I2C_TransferConfig(I2C_HandleTypeDef *hi2c,  uint16_t DevAddress, uint8_t Size, uint32_t Mode, uint32_t Request)
{
  ...
  tmpreg &= (uint32_t)~((uint32_t)((0x3FFU << (0U)) | (0xFFU << (16U)) | (0x1U << (24U)) | (0x1U << (25U)) | (0x1U << (10U)) | (0x1U << (13U)) | (0x1U << (14U))));

   
  tmpreg |= (uint32_t)(((uint32_t)DevAddress & (0x3FFU << (0U))) | (((uint32_t)Size << 16 ) & (0xFFU << (16U))) |             (uint32_t)Mode | (uint32_t)Request);
